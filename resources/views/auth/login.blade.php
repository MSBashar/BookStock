        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <x-text-input id="email" class="block mt-1 pl-10 w-full" type="email" name="email" :value="old('email')" placeholder="you@example.com" required autofocus autocomplete="username" />
                </div>
            ...
            <div class="mt-4">
                ...
                <div class="relative">
                    ...
                    <x-text-input id="password" class="block pl-10 mt-1 w-full" type="password" name="password" placeholder="••••••••" required autocomplete="current-password" />
                </div>
